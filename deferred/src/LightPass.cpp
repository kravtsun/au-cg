...
void LightPass::pass(const GLuint *geometryTextures,
                     ...
                     const std::vector<std::shared_ptr<Light>> &lights)
{
    ...
    texturePass.pass(geometryTextures[GBUFFER_TEXTURE_TYPE_AMBIENT]);
    ...
    for (int itex = 0; itex < texture_ids_count; ++itex) {
        ...
        glBindTexture(GL_TEXTURE_2D, geometryTextures[itex]);
